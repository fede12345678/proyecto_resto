...
def main(page: ft.Page):
    ...
    page.add(
        ft.Column([
            ...
            ft.Row([
                ft.Image(src=f, width=200, height=200, fit=ft.ImageFit.FILL) for f in FOTOS_MENU
            ], scroll="auto"),
            ft.Divider(),
            ft.Text("Reseñas", size=20, weight="bold", color=bordo),
            reseñas_column,
            ft.Text("Deja tu reseña", size=16, weight="bold", color=bordo),
            ft.Row([
                reseña_nombre,
